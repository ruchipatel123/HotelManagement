...
const Footer = () => {
  return (
    <footer className="relative mt-20 bg-gray-900 px-4 pt-20">
      <div className="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 text-4xl text-cyan-500 border-sky-500 bg-white p-2">
        <svg
      ...
      <p className="py-10 text-center text-gray-300">
        © 2024 Ruchi Patel | All Rights Reserved
      </p>
    </footer>
  );
};
